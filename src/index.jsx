.	Use an img tag to show the flag within the Flag component, so that html2canvas can render the image properly.
	2.	Ensure that html2canvas captures the background image or any other styles applied.
